 ...
 */
export const useNotificationManagerStore = create<NotificationManagerStore>()(
  (set, get) => ({
    // 初始状态
          ...
          if (
            ...
            if (commentData.momentDescription.id) {
              ...
              useMomentStore
                .getState()
                .addCommentLocally(
                  commentData.momentDescription.id,
                  localCommentData
                );
            }
          }
